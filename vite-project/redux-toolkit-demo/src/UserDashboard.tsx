...
const UserDashboard: React.FC = () => {
  ...
  const filteredUsers = useAppSelector(state =>
    selectFilteredUsers(state, searchTerm)
  );
  ...
  return (
    <div className="user-dashboard">
      ...
      <div className="user-dashboard__stats">
        ...
        <div className="stat-card">
          ...
          <p className="stat-card__value">
            {statistics.averagePostsPerUser.toFixed(1)}
          </p>
        </div>
        <div className="stat-card">
      ...
      <div className="user-dashboard__list">
        <h3 className="user-dashboard__list-title">
          ...
          {filteredUsers.map((user: User) => (
            <div key={user.id} className="user-card">
              ...
              <div className="user-card__actions">
                ...
                <button className="user-card__action-btn user-card__action-btn--delete">
                  Delete
                </button>
              </div>
            </div>
