...
const selectCurrentUserId = (state: RootState) =>
  state.userModule.currentUserId;
const selectSearchTerm = (state: RootState) => state.ui.searchTerm;
const selectDepartmentFilter = (state: RootState) =>
  state.ui.filters.departmentId;
...
const selectFilteredUsersWithPosts = createSelector(
  ...
  (usersWithDepartments, posts, searchTerm) => {
    ...
    const filteredUsers = usersWithDepartments.filter(
      user =>
...
const selectFilteredUsers = createSelector(
  ...
  (usersWithDepartments, departmentFilter) => {
    ...
    return usersWithDepartments.filter(
      user => user.departmentId === departmentFilter
    );
  }
);
